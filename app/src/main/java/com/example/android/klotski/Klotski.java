...
public class Klotski extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public Klotski(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBlockSpacing = ta.getDimension(R.styleable.Klotski_blockSpacing, DpParser.dp2px(getContext(), 3));
...
//        L.i(this, "surfaceChanged");
    ...
    protected Drawable resolveDrawable(Piece.Type type) {
        if (type == Piece.Type.RECT_1x1) {
            return mDrawable1x1;
        } else if (type == Piece.Type.RECT_1x2a) {
            return mDrawable1x2a;
        } else if (type == Piece.Type.RECT_1x2b) {
            return mDrawable1x2b;
        } else if (type == Piece.Type.RECT_1x2c) {
            return mDrawable1x2c;
        } else if (type == Piece.Type.RECT_1x2d) {
            return mDrawable1x2d;
        } else if (type == Piece.Type.RECT_2x1a) {
            return mDrawable2x1a;
        } else if (type == Piece.Type.RECT_2x1b) {
            return mDrawable2x1b;
        } else if (type == Piece.Type.RECT_2x1c) {
            return mDrawable2x1c;
        } else if (type == Piece.Type.RECT_2x1d) {
            return mDrawable2x1d;
        } else if (type == Piece.Type.RECT_2x2) {
            return mDrawable2x2;
        }
        return null;
    }
